...
Version **0.9.1** updates the police audit for armed drones, hover models and removal of old jail sentences; hunt, survival, cosmos and destruction audits remain available. Their
...
These are playable prototypes. The original Living City mode still has its separate heightfield and one-good economy. Voyager has an eight-good planetary core, city phone, field inventory, bounded police response with attack drones and destructible procedural buildings. The production follow-up adds table-facing furnishings, seven equipped supply models and pure regional support decisions with bounded material-specific Chaos debris. See `docs/phases/VOYAGER_PRODUCTION.md` for current build, save, multiplayer and visual evidence. The larger phase plan remains a roadmap: Mass traffic and large visible crowds, civilian vehicles/transit, mortgages, courts, voxel destruction and economic disasters are not part of this integration.
